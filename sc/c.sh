...
gcc -m32 -s -O2 -Wall -W -Wno-maybe-uninitialized -Wno-parentheses -Wno-char-subscripts -Wno-missing-field-initializers -Wno-sign-compare -Wno-empty-body -fno-strict-aliasing \
