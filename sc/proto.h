...
void common P((_CONST char *name));
void cseg P((void));
...
void dpseg P((void));
void dseg P((void));
void equ P((_CONST char *name, _CONST char *string));
void equlab P((label_t label, offset_t offset));
void globl P((_CONST char *name));
void import P((_CONST char *name));
void itol P((store_pt reg));
void lcommlab P((label_t label));
void lcommon P((_CONST char *name));
...
_CONST char *opstring P((op_pt op));
void outccname P((_CONST char *name));
...
struct typestruct *typename_ P((void));
...
void not_ P((struct symstruct *target));
...
/* output.c */
void bugerror P((_CONST char *message));
void closeout P((void));
void error P((_CONST char *message));
void error2error P((_CONST char *message1, _CONST char *message2));
void fatalerror P((_CONST char *message));
void finishup P((void));
void flushout P((void));
void limiterror P((_CONST char *message));
void initout P((void));
void openout P((_CONST char *oname));
void outbyte P((int ch));
void outcomma P((void));
void outcpplinenumber P((unsigned nr, _CONST char *fname, _CONST char *str));
void outhex P((uoffset_t num));
void outhexdigs P((uoffset_t num));
void outline P((_CONST char *s));
void outminus P((void));
void outnl P((void));
void outnbyte P((int byte));
void outnhex P((uoffset_t num));
void outnop1str P((_CONST char *s));
void outnop2str P((_CONST char *s));
void outnstr P((_CONST char *s));
void outop0str P((_CONST char *s));
void outop1str P((_CONST char *s));
void outop2str P((_CONST char *s));
void outop3str P((_CONST char *s));
void outplus P((void));
void outshex P((offset_t num));
void outstr P((_CONST char *s));
void outtab P((void));
...
void define P((void));
void definestring P((_CONST char *str));
...
void undefinestring P((_CONST char *str));
...
/* scan.c */
void cppscan P((void));
void eofin P((_CONST char *message));
...
/* table.c */
struct symstruct *addglb P((_CONST char *name, struct typestruct *type));
struct symstruct *addloc P((_CONST char *name, struct typestruct *type));
struct symstruct *addlorg P((_CONST char *name, struct typestruct *type));
void addsym P((_CONST char *name, struct typestruct *type,
...
struct symstruct *findlorg P((_CONST char *name));
struct symstruct *findstruct P((_CONST char *name));
struct symstruct **gethashptr P((_CONST char *sname));
...
void outofmemoryerror P((_CONST char *message));
void *qmalloc P((unsigned size));
void swapsym P((struct symstruct *sym1, struct symstruct *sym2));
void syminit P((void));

/* type.c */
struct typestruct *addstruct P((_CONST char *structname));
